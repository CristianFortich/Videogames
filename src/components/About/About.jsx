    ...
    <>
        <div className={aboutStyle.mainBox}>
            <div className={aboutStyle.aboutPage}>
                <p className={aboutStyle.pAboutMe}>
            ...
            <div className={aboutStyle.aboutMe}>
                <p className={aboutStyle.pAboutMe}>
                  ...
                  <p>Linkedin: <a target="_blank" className={aboutStyle.a} href='https://www.linkedin.com/in/cristian-fortich'>www.linkedin.com/in/cristian-fortich</a></p>
                  <p>GitHub: <a target="_blank" className={aboutStyle.a} href='https://github.com/CristianFortich'>CristianFortich</a></p>
                  <p>Gmail: <a target="_blank" className={aboutStyle.a} href = "mailto: yezidfortich@gmail.com">yezidfortich@gmail.com</a></p>
                </p>
            </div>
        </div>
    </>
